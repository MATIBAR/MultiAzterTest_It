...
class NLPCharger:
    ...
    def download_model(self):
        if self.lib == "stanford":
            ...
            print("You cannot use this library. Introduce a valid library (Stanford)")
        ...
        if self.lib == "stanford":
            ...
            if self.lang == "basque":
                ...
                config = {'processors': 'tokenize,pos,lemma,depparse',  # Comma-separated list of processors to use
                          ...
                          'tokenize_model_path'   : MODELS_DIR + f'/{it_model}_models/{it_model}_tokenizer.pt',
                          # Processor-specific arguments are set with keys "{processor_name}_{argument_name}"
                          'pos_model_path'        : MODELS_DIR + f'/{it_model}_models/{it_model}_tagger.pt',
                          'pos_pretrain_path'     : MODELS_DIR + f'/{it_model}_models/{it_model}.pretrain.pt',
                          'lemma_model_path'      : MODELS_DIR + f'/{it_model}_models/{it_model}_lemmatizer.pt',
                          'depparse_model_path'   : MODELS_DIR + f'/{it_model}_models/{it_model}_parser.pt',
